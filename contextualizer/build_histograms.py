...
def plot_histograms(df: pd.DataFrame, output_dir: str):
    ...
    """
    columns_to_plot = ['orig_len', 'trans_len', 'labse_distance', 'orig_ppl', 'trans_ppl', 'abs_len_difference', 'sum_ppl']
...
def main():
    parser = argparse.ArgumentParser(description='Process and visualize a large dataset.')
    parser.add_argument('input_file', type=str, help='Path to the input CSV file.')
    parser.add_argument('output_dir', type=str, help='Directory to save the histograms.')
